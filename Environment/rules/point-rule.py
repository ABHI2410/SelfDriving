...
class Rules:
    ...
    def obey_speed_limit(self):
        ...
        if current_speed > speed_limit:
            return -10, "Speeding"  # Negative reward for speeding
    ...
    def stop_at_red_traffic_light(self):
        ...
        if traffic_light_state == carla.TrafficLightState.Red:
            return -10, "Red light violation"  # Negative reward for running a red light
    ...
    def avoid_collisions(self):
        ...
        if collision_detected:
            return -20, "Collision"  # Large negative reward for collisions
    ...
    def stay_in_lane(self):
        ...
        if lane_invasion_detected:
            return -5, "Lane invasion"  # Negative reward for lane invasion
